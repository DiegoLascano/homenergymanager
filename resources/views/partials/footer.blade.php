<footer class="bg-white flex flex-col md:flex-row items-center md:justify-between text-grey-600 text-sm p-4">
    ...
    <div class="text-center my-1 md:my-0">
        &copy; Diego Lascano. Derechos reservados
    </div>
</footer>