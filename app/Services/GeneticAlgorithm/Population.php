...
class Population
{
    ...
    /**
     * Fitness of the entire population (array or collection)
     *
     * @var double
     */
    ...
    *
    * @param int $populationSize Size of the new population
    * @param OST $ost Operation start time vector
    */
    public function __construct($populationSize = null, $chromosomeLength = null)
    {
        $this->population = [];
    ...
    public function getFittest($index)
    {
        //print "Before:\n";
        //print $this;
        // usort ordena la poblacion y el $index=0 es la mejor
    ...
    /**
     * Set the population fitness for the population
     *
     ...
     *
     * @return double The fitness of the population
     */
